!(function (t) {
    t.fn.extend({
        easyResponsiveTabs: function (a) {
            var e = (a = t.extend({ type: "default", width: "auto", fit: !0, closed: !1, activate: function () {} }, a)),
                s = e.type,
                i = e.fit,
                n = e.width,
                r = "vertical",
                    ...
                    o.find(".resp-tab-item").each(function () {
                        ($tabItem = t(this)),
                            ...
                            !0 === a.closed ||
                                ...
                                (o.find(".resp-tab-item").first().addClass("resp-tab-active"),
                        ...
                        o.find("[role=tab]").each(function () {
                            ...
                            a.click(function () {
                                ...
                                if (a.hasClass("resp-accordion") && a.hasClass("resp-tab-active"))
                                    return (
                                        o.find(".resp-tab-content-active").slideUp("", function () {
                                            t(this).addClass("resp-accordion-closed");
                                        }),
                                        a.removeClass("resp-tab-active"),
                                        !1
                                    );
                                !a.hasClass("resp-tab-active") && a.hasClass("resp-accordion")
