...
function App(props) {
  ...
  return (
    ...
    <div className="App">
      <Layout>
        <Header className="header" style={{ padding: 10 ,backgroundColor:'#ffff'}}>
        <Avatar style={{ float: 'right' }} src='https://media-exp1.licdn.com/dms/image/C5635AQEVfuzl1rug3w/profile-framedphoto-shrink_200_200/0?e=1598472000&v=beta&t=vF-10djb1UEq8ny_7qzXUC5zBDle4GbrmmY7xI30WjE' />
          ...
          <Layout>
            <Content style={{ padding: '0 50px' }}>
              ...
              <div style={{ background: '#fff', padding: 24, minHeight: 580 }}>
                <Cricketer id="PlayerDetailes" name={props.player.name} team='IND' avatarSrc='https://media-exp1.licdn.com/dms/image/C4D35AQFwd5vvnCorzw/profile-framedphoto-shrink_200_200/0?e=1598551200&v=beta&t=H3r64E_NMSG4WMtfTPGUOY7B-QTsklS2JXVsIdi9Q4w'>
                ...
                <Cricketer name={props.player1.name1} team='IND' avatarSrc='https://media-exp1.licdn.com/dms/image/C5635AQEVfuzl1rug3w/profile-framedphoto-shrink_200_200/0?e=1598472000&v=beta&t=vF-10djb1UEq8ny_7qzXUC5zBDle4GbrmmY7xI30WjE'>
